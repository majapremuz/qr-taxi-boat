...
@Component({
  selector: 'app-one-way-ticket',
  templateUrl: './one-way-ticket.page.html',
  styleUrls: ['./one-way-ticket.page.scss'],
})
export class OneWayTicketPage implements OnInit {
  currentPage: string = 'one-way-ticket';
